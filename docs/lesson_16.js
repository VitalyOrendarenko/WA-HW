...
var _taskComments = __webpack_require__(380);

var comments = new _taskComments.TaskComments(document.querySelector('.test'));
...
exports.TaskComments = undefined;
...
var TaskComments = exports.TaskComments = function () {
    function TaskComments(target) {
        var _this = this;
        ...
        this.target = target;
        this.render();
        _ajax.Ajax.get('http://localhost:4001/comments', function (list) {
    ...
    _createClass(TaskComments, [{
        key: 'sendData',
        value: function sendData() {
            _ajax.Ajax.post('http://localhost:4001/comments', {
